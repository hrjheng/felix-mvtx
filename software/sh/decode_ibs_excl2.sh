...
commands=(
    'echo "Fee id 12 decoding in background..." && env -i bash -c "lz4 -d -f ~/tmp_data/daqtest_ibs_excl_2.lz4" | ../py/decode.py -i 12 -cp ~/tmp_data/daqtest_ibs_excl2_final_counters.json -cll 0,1'
    )
