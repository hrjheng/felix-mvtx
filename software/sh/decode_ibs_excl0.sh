...
commands=(
    'echo "Fee id 12 decoding in background..." && env -i bash -c "lz4 -d -f ~/tmp_data/daqtest_ibs_excl_0.lz4" | ../py/decode.py -i 12 -cp ~/tmp_data/daqtest_ibs_excl0_final_counters.json -cll 1,2'
    )
