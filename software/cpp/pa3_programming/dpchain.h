...
#ifdef CHAIN_SUPPORT
#include <stdint.h> // ITS modification, for uint32_t

#define PREIR_DATA_SIZE       1u
#define PREDR_DATA_SIZE       1u
#define POSTIR_DATA_SIZE      1u
#define POSTDR_DATA_SIZE      1u
#define PREIR_LENGTH_VALUE    6u // Modified for ITS RU
#define PREDR_LENGTH_VALUE    1u // Modified for ITS RU
...
uint32_t take_26bit_tdi_out(DPULONG DataIndex);
void test_sp();
#endif /* CHAIN_SUPPORT */
#endif /* INC_DPCHAIN_H */
