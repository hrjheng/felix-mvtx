...
#include "dpalg.h"
#include "dpG3alg.h"
//#include "dpG4alg.h" // ITS: disable as not in repo
//#include "dpG5alg.h" // ITS: disable as not in repo
//#include "dpRTG4alg.h" // ITS: disable as not in repo
#include "dpjtag.h"
#include "dpcom.h"
...
*/
DPULONG DataIndex;
DPULONG DataIndex_sp; // ITS specific
...
void dp_read_idcode(void)
{
    ...
    #ifdef ENABLE_DISPLAY
    dp_display_text("\r\nIDCODE = "); //ITS modification, was ActId, but it is not ActID as bits are not masked
