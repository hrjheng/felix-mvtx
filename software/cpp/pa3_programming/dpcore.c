...
void dp_load_row_data(void)
{
    ...
    // TODO clearify comments below #156
    // 5-bit jtag_state, 6-bit shift_in, 8-bit shift-in, 1-bit jtag_state,
    // in total, 5+6+8+1 = 20 bit
    // + jtag state jump, current_jtag_state = 8
    ...
    {
        // TODO clearify comments below #156
        // the first iteration    : tms 5, shift_in 1, shift_in 26, tms 1, tms 3 tms 3
        // all the rest iteration : tms 4, shift_in 1, shift_in 26, tms 1, tms 3 tms 3
        // 48 iterations
        for ( SDNumber = 1u; SDNumber <= device_SD; SDNumber++ ) // device_SD * 8 iterations
        {
