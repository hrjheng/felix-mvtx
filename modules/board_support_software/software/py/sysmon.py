...
class Sysmon(WishboneModule):
    ...
    def log_temperature(self):
        self.logger.info("T: {0:.2f} C".format(self.get_temperature()))
    ...
    def log_voltages(self):
        self.logger.info(f'V_INT\t{self.get_vcc_int():.3f} V')
        self.logger.info(f'V_AUX\t{self.get_vcc_aux():.3f} V')
        self.logger.info(f'V_REF_P\t{self.get_vref_p():.3f} V')
        self.logger.info(f'V_REF_N\t{self.get_vref_n():.3f} V')
        self.logger.info(f'V_BRAM\t{self.get_vcc_bram():.3f} V')
        self.logger.info(f'V_3V3\t{self.get_vcc_alpide_3v3():.3f} V')
        self.logger.info(f'V_1V5\t{self.get_vcc_sca_1v5():.3f} V')
