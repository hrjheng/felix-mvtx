...
class TTI:
    ...
    def setup_logging(self):
        ...
        log_file = os.path.join(logdir, "tti.log")
    ...
    def get_channel_config_all(self):
        ...
        for channel in range(1, self.number_channels+1):
            ...
            msg = "Channel {0}: {1:.3f}V, {2:.3f}A, OVP:{3:.3f}V, OCP:{4:.4f}A {5}".format(
                channel, voltage, current, ovp, ocp, active_str[active])
    ...
    def get_fuse_triggered(self, channel):
        ...
        # Bit 6: Set when a trip has occurred that can only be reset from the front panel or
        # by removing and reapplying the AC power.
    ...
    def get_power(self, channel):
        ...
        msg = "Channel {0}: {1:.3f} V, {2:.0f} mA, {3:.2f} W".format(
